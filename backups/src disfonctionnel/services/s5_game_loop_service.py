...
class GameLoopService:
    def __init__(self, session_service: SessionSetupService, 
        ...
        self.last_dirty_bounds: Optional[Tuple[int, int, int, int]] = None
        ...
        self.smart_scan_service = SmartScanService(paths=self.game_paths)
    ...
    def execute_single_pass(self, iteration_num: int = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self._update_dirty_bounds(scan_result.get('dirty_sets'))
